...
(123, '', 'Dodi Setiawan123', 'Surabaya', '0000-00-00', '', '', '', '', '', '', '0000-00-00', '0000-00-00', 'default.jpg'),
...
(1, '127.0.0.1', 'administrator', '$2y$10$LIAhhUtYk8cetV5q3cFqCundFuzMcj58rpzDn94JvwtbxlvLCYJVO', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1673837458, 1, 'Admin', 'istrator', 'ADMIN', '0');
...
--
ALTER TABLE `mk_jabatan`
  MODIFY `idmk_jabatan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `mk_pendidikan`
--
ALTER TABLE `mk_pendidikan`
  MODIFY `idmk_pendidikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `mk_renumerasi`
--
ALTER TABLE `mk_renumerasi`
  MODIFY `idmk_renumerasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
